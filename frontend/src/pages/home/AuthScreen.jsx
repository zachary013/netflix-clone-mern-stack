    ...
    return (
        <div className="hero-bg relative">
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center jusrify-center md:flex-row flex-col px-4 md:px-2">
                    {/* Left side */}
            ...
            {/* 2nd section */}
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center jusrify-center md:flex-row flex-col-reverse px-4 md:px-2">
                    {/* Left side */}
                    <div className="flex-1 relative">
